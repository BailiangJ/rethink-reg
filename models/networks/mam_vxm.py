...
from .utils import FlowConv, MambaLayer, LayerNorm, MlpChannel
    ...
    def __init__(
        ...
        for i in range(self.num_levels):
            self.stages.append(
                nn.Sequential(
                    *[
                        MambaLayer(out_channels[i], d_state, d_conv, expand, res_skip)
        ...
        for i in range(self.num_levels):
            ...
            self.mlps.append(MlpChannel(spatial_dims, out_channels[i], mlp_ratio * out_channels[i]))
