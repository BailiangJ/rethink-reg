...
project = "LUMIR"
group = "pwc-iter"
name = "pwc_iter-1lncc+0.5diffusion"

# output directory
out_path = "./pwc_iter_outputs/exp7"
...
lr_decay = 0.996
start_epoch = 0
# The manuscript checkpoint (pwc_iter_outputs/exp7) was trained for 100 epochs.
max_epochs = 100
save_interval = 50
val_interval = 5
