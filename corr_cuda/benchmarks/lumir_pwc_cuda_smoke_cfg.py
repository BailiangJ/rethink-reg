...
project = "LUMIR"
group = "pwc"
name = "pwc-1lncc+0.5diffusion"

# output directory
out_path = "./pwc_outputs/exp0"
...
model_cfg = dict(
    ...
    config=dict(
        ...
        decoder_cfg=dict(
            image_size=image_size,
            spatial_dims=3,
            skip_channels=[16, 16, 16, 8],
            corr_radius=[1, 1, 1, 1],
            out_channels=[16, 16, 16, 8],
            out_indices=[4, 3, 2, 1],
